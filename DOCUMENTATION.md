...
### InstaPy Pods
 ...
 Topic of the posts to be interacted with. `general` by default.
  ...
  > Note :  Topics allowed are {'general', 'fashion', 'food', 'travel', 'sports', 'entertainment'}. But it is highly recomended to use 'general' till we gain sufficient users in each of the topics.
